...
import { Building, Shield, Truck } from 'lucide-react';
                        ...
                        <div className="grid md:grid-cols-5 gap-8">
                            ...
                            <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-lg border border-gray-200 hidden md:block">
                                <div className="mb-6">
                                    ...
                                    <p className="text-gray-600">
                                        Create your supplier account to connect with street food vendors and grow your business with:
                                    </p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <FeatureCard 
                                        ...
                                        description="Manage your product catalog and connect with vendors across multiple locations."
                                    />
                                    <FeatureCard 
                                        icon={<Shield className="h-6 w-6 text-green-600" />}
                                        title="Verified Network"
                                        description="Join our verified supplier network with transparent ratings and secure transactions."
                                    />
                                    <FeatureCard 
                                        icon={<Truck className="h-6 w-6 text-green-600" />}
                                        title="Efficient Distribution"
                                        description="Optimize your distribution routes and manage deliveries with our logistics platform."
                                    />
                                </div>
                                
                                <div className="mt-8 p-4 bg-green-50 rounded-lg">
                                    <p className="text-green-800 text-sm italic">
                                        "SupplyMind has helped us reach more vendors and streamline our supply chain operations!"
                                    </p>
                                    <p className="text-right text-green-600 font-semibold text-sm mt-2">
                                        — Priya Sharma, Food Distributor
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-3 bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200">
                                <div className="text-center mb-6">
                                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Create Supplier Account</h2>
                                    <p className="text-gray-600">Join our network of trusted suppliers</p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Input
                                        ...
                                        type="text"
                                        placeholder="Complete address of your business"
                                    ...
                                    <Input
                                        label="Business Type"
                                        type="text"
                                        placeholder="e.g., Food Distributor, Packaging Supplier"
                                ...
                                <p className="mt-6 text-center text-sm text-gray-600">
                                    ...
                                    <Link href="/supplier/login" className="font-semibold text-green-600 hover:text-green-500">
                                        Sign in
                                    </Link>
                                </p>
                            </div>
